...
public class UpdateUserRequestValidatorTests
{
    ...
    {
        // Arrange
        var request = new UpdateUserRequest { Name = "John123", Email = "test@example.com" };
    ...
    {
        // Arrange
        var request = new UpdateUserRequest { Name = "John Doe", Email = "" };
    ...
    {
        // Arrange
        var request = new UpdateUserRequest { Name = "John Doe", Email = "invalid-email" };
    ...
    public void Should_Have_Error_When_Email_Exceeds_MaxLength()
    {
        ...
        var request = new UpdateUserRequest { Name = "John Doe", Email = longEmail };
